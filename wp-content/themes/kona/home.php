...
<main class="main-wrapper">
      ...
      <div class="categrie-product-activation-2 categorie-product-two slick-layout-wrapper--15">
        <div class="slick-single-layout slick-slide">
          <div class="categrie-product-2">
            <a href="#">
              <img class="img-fluid" src="<?php echo get_template_directory_uri() . '/img/stickerebi/1.png'; ?>" alt="product categorie">
            </a>
          </div>
        ...
        <div class="slick-single-layout slick-slide">
          <div class="categrie-product-2">
            <a href="#">
              <img class="img-fluid" src="<?php echo get_template_directory_uri() . '/img/stickerebi/2.png'; ?>" alt="product categorie">
            </a>
          </div>
          <!-- End .categrie-product -->
        </div>
        ...
        <div class="slick-single-layout slick-slide">
          <div class="categrie-product-2">
            <a href="#">
              <img class="img-fluid" src="<?php echo get_template_directory_uri() . '/img/stickerebi/3.png'; ?>" alt="product categorie">
            </a>
          </div>
          <!-- End .categrie-product -->
        </div>
        ...
        <div class="slick-single-layout slick-slide">
          <div class="categrie-product-2">
            <a href="#">
              <img class="img-fluid" src="<?php echo get_template_directory_uri() . '/img/stickerebi/4.png'; ?>" alt="product categorie">
            </a>
          </div>
          <!-- End .categrie-product -->
        </div>
      ...
      <div class="slider-box-wrap">
        <div class="slider-activation-two axil-slick-dots">
          <div class="single-slide slick-slide">
            <div class="background-image" style="background-image: url(<?php echo get_template_directory_uri() . '/img/partials/madtown/sabanero.jpeg'; ?>);"></div>
            <div class="main-slider-content">
              <span class="subtitle"><i class="fas fasblack fa-fire"></i> ახალი კოლექცია</span>
              <h1 class="title">Mad Town</h1>
              <h5 class="subtitle">In the heart of the Mad Town, there thrived a notorious group of kids known for their wild antics and fearless spirit.
                They were the unruly denizens of a place where the ordinary dared not tread, where every day was a chaotic adventure waiting to unfold.</h5>
              <div class="shop-btn">
                <a href="shop.html" class="axil-btn btn-bg-white"><i class="fal fa-shopping-cart"></i> Shop Now</a>
              </div>
            </div>
            <div class="main-slider-thumb">
              <img class="nopacity" src="<?php echo get_template_directory_uri() . '/img/partials/madtown/gnolo.jpg'; ?>" alt="Product">
            </div>
          </div>
          <div class="single-slide slick-slide">
            <div class="main-slider-content">
    ...
    <div class="container">
      <div class="product-area pb--80">
        <div class="section-title-wrapper">
          <span class="title-highlighter highlighter-primary"> <i class="far fa-shopping-basket"></i> ჩვენი პროდუქტი</span>
          <h2 class="title">რამე პროდუქტის ტექსტი</h2>
        </div>
  ...
  <div class="axil-testimoial-area axil-section-gap bg-vista-white">
    <div class="container">
      <div class="section-title-wrapper">
        <span class="title-highlighter highlighter-secondary"> <i class="fal fa-quote-left"></i>#konastore</span>
        <h2 class="title">ჩვენი ინსტაგრამის ჰეშთეგ დათაგული ხალხი თუ რაღაც მოვიფიქრებთ ამას :დ</h2>
      </div>
      <!-- End .section-title -->
            ...
            ?>
              ...
              <div class="col">
                <div class="categrie-product categrie-product-4" data-sal="zoom-out" data-sal-delay="100" data-sal-duration="500">
                  <a href="<?php echo esc_url($category_link); ?>" class="cate-thumb">
                    <img src="<?php echo esc_url($category_thumbnail_url); ?>" alt="<?php echo esc_attr($category->name); ?>">
                    <h5 class="cat-title"><?php echo esc_html($category->name); ?></h5>
                  </a>
                </div>
              </div>
